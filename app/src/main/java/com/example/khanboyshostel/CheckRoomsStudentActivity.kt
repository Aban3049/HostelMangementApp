...
import com.example.khanboyshostel.databinding.ActivityCheckRoomsStudentBinding
...
class CheckRoomsStudentActivity : AppCompatActivity() {

    private lateinit var binding: ActivityCheckRoomsStudentBinding

    private lateinit var mDatabase: DatabaseReference

    private lateinit var roomAdapter: AdapterCheckRoom

    private lateinit var roomList: List<Room>

    override fun onCreate(savedInstanceState: Bundle?) {

        binding = ActivityCheckRoomsStudentBinding.inflate(layoutInflater)
    ...
    private fun loadRooms() {
        ...
        mDatabase.child("rooms").addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                roomAdapter = AdapterCheckRoom(this@CheckRoomsStudentActivity, roomList)
                // Create adapter after data is available
                binding.recyclerViewRooms.layoutManager =
                    LinearLayoutManager(this@CheckRoomsStudentActivity)
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(
                    this@CheckRoomsStudentActivity,
